				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo1.jpg" alt="" class="w-100" />
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo2.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo3.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo4.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo5.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo6.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo7.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo8.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo9.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo10.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo11.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo12.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo13.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo14.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo15.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo16.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo17.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo18.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo19.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo20.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo21.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo22.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo23.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo24.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo25.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo26.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo27.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo28.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo29.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="#/demos/demo30.jpg" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
						</div>
...
<script>
import HeaderMovil from './plantilla/HeaderMobile'
import Aside from './plantilla/Aside'

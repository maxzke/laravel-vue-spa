      ...
      >
        ...
        >
          ...
          >
            ...
            <ul class="menu-nav">
              <li
                class="menu-item menu-item-submenu menu-item-rel menu-item-active"
                    ...
                    >
                      ...
                      <a href="#" class="navi-item">
                        <div class="navi-link">
                          <div class="navi-icon mr-2">
                            <i
                              class="flaticon2-user flaticon2-line- text-success"
                            ></i>
                          </div>
                          <div class="navi-text">
                            <div class="font-weight-bold">
            ...
            >
              <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                <img
                  ...
                  :src="ruta+'/assets/media/svg/flags/226-united-states.svg'"
                  alt=""
                />
              </div>
            </div>
              ...
              <ul class="navi navi-hover py-4">
                ...
                <li class="navi-item">
                  <a href="#" class="navi-link">
                    <span class="symbol symbol-20 mr-3">
                      <img
                        :src="ruta+'/assets/media/svg/flags/162-germany.svg'"
                        alt=""
                      />
                    </span>
                ...
                <li class="navi-item">
                  <a href="#" class="navi-link">
                    <span class="symbol symbol-20 mr-3">
                      <img :src="ruta+'/assets/media/svg/flags/063-japan.svg'" alt="" />
                    </span>
                ...
                <li class="navi-item">
                  <a href="#" class="navi-link">
                    <span class="symbol symbol-20 mr-3">
                      <img :src="ruta+'/assets/media/svg/flags/195-france.svg'" alt="" />
                    </span>
